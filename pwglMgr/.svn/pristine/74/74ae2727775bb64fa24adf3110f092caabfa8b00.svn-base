package com.ydp.pwgl.controller.pricelevel;

import com.ydp.face.BaseController;
import com.ydp.pwgl.service.pricelevel.PriceLevelService;
...
public class PriceLevelController extends BaseController {
    ...
    public DataResult select(@Context HttpServletRequest request,
        ...
        try {
            priceLevelService.service(param);
        } catch (Exception e) {
            return null;
        }
