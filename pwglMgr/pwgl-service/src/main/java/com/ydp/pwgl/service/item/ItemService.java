...
public class ItemService extends BaseService implements IService {
    ...
    public void insertItem(Param param) {
        if(!param.containsKey("itemname") || !param.containsKey("producttypeid") || !param.containsKey("introduction")
                || !param.containsKey("venueid") || !param.containsKey("sel_status") || !param.containsKey("starttime")
                || !param.containsKey("endtime") || !param.containsKey("theme_img") || !param.containsKey("image_path_arr")
                || !param.containsKey("vedio_path_arr") || !param.containsKey("cid")) {
    ...
    public void updateItem(Param param) {
        if(!param.containsKey("itemname") || !param.containsKey("producttypeid") || !param.containsKey("introduction")
                || !param.containsKey("venueid") || !param.containsKey("sel_status") || !param.containsKey("starttime")
                || !param.containsKey("endtime") || !param.containsKey("theme_img") || !param.containsKey("image_path_arr")
                || !param.containsKey("vedio_path_arr") || !param.containsKey("mid")) {
            result.setStatusCode(StatusCode.MissingParams);
            param.setResult(result);
            return;
        }
